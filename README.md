...
- 🌐 **WordPress Integration** - Complete WordPress setup and management
- 🗄️ **Database Management** - MariaDB/MySQL administration tools
- 📊 **System Monitoring** - Built-in system information and log viewing
- ⌨️ **Keyboard Layout Configuration** - Easy keyboard setup
...
- **Neovim** - Modern Vim-based editor [APT]
...
- **Apache2** - Apache HTTP Server [APT]
- **PHP-FPM** - PHP FastCGI Process Manager [APT]
- **LibApache2-mod-php** - PHP module for Apache [APT]
- **PHP-MySQL** - PHP MySQL extension [APT]
- **PHP-Curl** - PHP cURL extension [APT]
- **PHP-GD** - PHP GD graphics extension [APT]
- **PHP-XML** - PHP XML extension [APT]
- **PHP-Mbstring** - PHP multibyte string extension [APT]
- **PHP-Zip** - PHP ZIP extension [APT]
- **MariaDB** - MariaDB database server [APT]
- **Certbot** - Let's Encrypt SSL certificate tool [APT]
...
- **Nmon** - Nigel's Monitor - modular system statistics [APT]
- **Atop** - Advanced system and process monitor [APT]
...
- **Fail2ban** - Intrusion prevention system [APT]
...
- **LibreOffice** - LibreOffice office suite [APT]
- **Thunderbird** - Thunderbird email client [APT]
- **Calibre** - E-book management [APT]
- **Obsidian** - Knowledge management [SNAP]
...
seriously its just a bunch of terminal stickytaped together go nuts.
